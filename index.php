    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><strong>Your Title</strong></h3>
            </div>
            <div class="panel-body">
                <div class="col-md-8">
                    <strong>Job 1</strong>
                    <p align="justify">Description of Job</p>
                </div>
                <div class="col-md-4" align="right"><em>2000 - 2021</em></div>
            </div>
        </div>
        <br /><br />
        <div class="panel panel-default">
        ...
        <br /><br />
        <p align="center">&copy; Fatima Hiprenoridel Joven - All Rights Reserved</p>
    </div>
</body>
